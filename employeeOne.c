...
PtrToEmployee searchEmployeeByPhone(PtrToEmployee ptr, int tableSize, char * targetPhone)
{
    const PtrToConstEmployee endPtr = ptr + tableSize;
...
PtrToEmployee searchEmployeeBySalary(PtrToEmployee ptr, int tableSize, double targetSalary)
{
