...
//targetPtr - points to value that will be searched for in the table
...
//() (the second set of parentheses is the arguements of the function call)
...
//The function functionPtr will point to one of these comparison functions to perform a check
...
{
    return strcmp((char *) targetPtr, tableValuePtr->name); //const void *targetPtr ==> typecast asa char pointer then pass into strcmp()
}
...
PtrToEmployee searchEmployeeByPhone(PtrToEmployee ptr, int size, char* phone)
{
